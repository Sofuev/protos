...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x04Auth\x128\n" +
	"\aRegiser\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aisAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x15Z\x13forFun.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Regiser:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.isAdmin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Auth.Regiser:output_type -> auth.RegisterResponse
